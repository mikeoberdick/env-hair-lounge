...
(function (global, factory) {
	...
	*/
	...
	jQuery(function ($) {
	  ...
	  $('.hero .inner-container').css('margin-top', headerHeight / 2 + 'px'); //Smooth scroll behavior for jump links
	  ...
	  if ($(window).width() >= 992) {
	    ...
	    $('.offset-right').css('padding-right', Math.ceil(offset.left) + 15 + 'px'); //Get the height of the image within an absolutely positioned div to force the height of the section
	    ...
	    $('#otherSpecialties #sectionTwo .image-wrapper').css('position', 'absolute'); //Force a section to be the width of column plus the gutter (left or right)
